...
\begin{figure}[H]
    \centering
    \subfloat[][Value Iteration and Policy Iteration.]{\includegraphics[width=.4\linewidth]{../paper_figs/value_iteration}\label{fig:value_iteration_simple}}
    \subfloat[][$q$-value Iteration.]{\includegraphics[width=.4\linewidth]{../paper_figs/q_value_iteration_simple}\label{fig:q_value_iteration_simple}}
